...
자세한 사용법: [더미 데이터 생성 가이드](./backend/README_DUMMY_DATA.md)
...
# 2. Docker Compose로 백엔드 시작
docker-compose up -d

# 3. 백엔드 로그 확인
docker-compose logs -f backend

# 4. 프론트엔드 실행 (별도 터미널, 프로젝트 루트에서)
cd ..  # 프로젝트 루트로 이동
npm install
npm run dev
```
